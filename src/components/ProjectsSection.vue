...
const projects: Project[] = [
  {
    name: "Trasul Plus",
    description:
      "Gmail-like internal messaging platform used by 1,000+ Ministry of Finance employees",
  ...
  },
  {
    name: "Smashi TV",
    description:
      "Regional digital streaming and media platform for MENA audiences",
  ...
  },
  {
    name: "Heart Of Rak",
    description:
      "Government-backed digital content platform by Ras Al Khaimah Government",
  ...
  },
  {
    ...
    description:
      "Government e-Tendering platform supporting procurement workflows",
