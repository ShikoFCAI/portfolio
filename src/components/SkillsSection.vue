...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: ["Vue 3", "Nuxt 3/4", "Angular 18/19", "React"],
  },
  {
    title: "Languages",
  ...
  {
    title: "Styling & UI",
    skills: ["Tailwind CSS", "Nuxt UI", "Vuetify", "ShadCN UI", "Bootstrap"],
  },
  {
    title: "Tools & Platforms",
    skills: ["Git", "Azure DevOps", "REST APIs", "Vite"],
  },
  {
    title: "Concepts",
    skills: [
  ...
  <section id="skills" class="py-20 bg-slate-800/50">
    <div class="container mx-auto px-6">
      <div class="max-w-6xl mx-auto">
        ...
        >
          Technical <span class="text-gradient-amber">Skills</span>
        </h2>
        <p
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div
              class="bg-slate-900/50 rounded-xl p-6 border border-slate-700 hover:border-amber-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 gradient-border-animated"
            >
              ...
              <div class="flex flex-wrap gap-2">
                <span
                  ...
                  :key="skill"
                  class="px-3 py-2 bg-slate-800 text-slate-300 rounded-lg text-sm hover:bg-amber-500/20 hover:text-amber-300 transition-all duration-300"
                  :style="{
                    animation: `float 3s ease-in-out ${si * 0.3}s infinite`,
                  }"
                >
                  {{ skill }}
                </span>
